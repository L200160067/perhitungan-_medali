...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\GitHub\perhitungan-_medali\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\GitHub\\perhitungan-_medali\\public\\storage','logging.default','logging.deprecations.channel',
...
'boost.executable_paths.composer','boost.executable_paths.npm','boost.executable_paths.vendor_bin','mcp.redirect_domains','ide-helper.filename',
...
'generated::u7F64sZjuBrTfIkr','generated::TlEaqVOqziFTbEEH','dashboard','profile.edit','profile.update',
'profile.destroy','events.import','events.storeImport','events.bulkDestroy','events.index',
'events.create','events.store','events.show','events.edit','events.update',
'events.destroy','tournament-categories.import','tournament-categories.storeImport','tournament-categories.bulkDestroy','tournament-categories.index',
'tournament-categories.create','tournament-categories.store','tournament-categories.show','tournament-categories.edit','tournament-categories.update',
'tournament-categories.destroy','dojangs.import','dojangs.storeImport','dojangs.bulkDestroy','dojangs.index',
'dojangs.create','dojangs.store','dojangs.show','dojangs.edit','dojangs.update',
'dojangs.destroy','participants.import','participants.storeImport','participants.bulkDestroy','participants.index',
'participants.create','participants.store','participants.show','participants.edit','participants.update',
'participants.destroy','contingents.import','contingents.storeImport','contingents.bulkDestroy','contingents.index',
'contingents.create','contingents.store','contingents.show','contingents.edit','contingents.update',
'contingents.destroy','registrations.import','registrations.storeImport','registrations.bulkDestroy','registrations.index',
'registrations.create','registrations.store','registrations.show','registrations.edit','registrations.update',
'registrations.destroy','medals.index','medals.create','medals.store','medals.show',
'medals.edit','medals.update','medals.destroy','register','generated::mNQbSUiOkVST0CdW',
'login','generated::u76Rqd9d2YYxVNgt','password.request','password.email','password.reset',
'password.store','verification.notice','verification.verify','verification.send','password.confirm',
'generated::N8XGSIRS1Ak6KKO0','password.update','logout','storage.local',);
        registerArgumentsSet('views', 
'auth.confirm-password','auth.forgot-password','auth.login','auth.register','auth.reset-password',
'auth.verify-email','components.alert','components.application-logo','components.auth-session-status','components.danger-button',
'components.dropdown','components.dropdown-link','components.input-error','components.input-label','components.modal',
'components.nav-link','components.navigation','components.primary-button','components.responsive-nav-link','components.secondary-button',
'components.text-input','contingents.create','contingents.edit','contingents.import','contingents.index',
'contingents.show','dashboard','dojangs.create','dojangs.edit','dojangs.import',
'dojangs.index','dojangs.show','errors.403','errors.404','errors.500',
'events.create','events.edit','events.import','events.index','events.show',
'layouts.app','layouts.guest','layouts.navigation','medals.create','medals.edit',
'medals.index','participants.create','participants.edit','participants.import','participants.index',
'participants.show','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form',
'registrations.create','registrations.edit','registrations.import','registrations.index','registrations.show',
'tournament-categories.create','tournament-categories.edit','tournament-categories.import','tournament-categories.index','tournament-categories.show',
...
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'D:.GitHub.perhitungan-_medali.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
