<x-app-layout title="Import Pertandingan">
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Import Pertandingan') }}
        </h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="mb-6">
                        ...
                        <ul class="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1">
                            ...
                            <li>Kolom yang wajib ada: <strong>nama_pertandingan</strong>, <strong>tanggal_mulai</strong>, <strong>tanggal_selesai</strong>.</li>
                            <li>Kolom opsional: <strong>lokasi</strong>, <strong>deskripsi</strong>.</li>
                            <li>Format Tanggal: YYYY-MM-DD atau format Excel Date.</li>
                        </ul>
                    </div>
                    ...
                    <form action="{{ route('events.storeImport') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <a href="{{ route('events.index') }}" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100">{{ __('Batal') }}</a>
                        </div>
                    </form>
                </div>
            </div>
