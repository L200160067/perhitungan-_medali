<x-app-layout title="Edit Pertandingan">
    <x-slot name="header">
                ...
                <div class="space-y-6">
                    ...
                    <div class="relative flex items-start">
                        <div class="flex h-6 items-center">
                            <input id="count_festival_medals" aria-describedby="count_festival_medals-description" name="count_festival_medals" type="checkbox" value="1" {{ old('count_festival_medals', $event->count_festival_medals) ? 'checked' : '' }} class="h-4 w-4 rounded border-gray-300 dark:border-gray-700 text-blue-600 focus:ring-blue-600 dark:bg-gray-900">
                        </div>
