            ...
            <div class="space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden" x-data="{ 
                    ...
                    <div class="p-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
                        <form id="bulk-delete-form" action="{{ route('contingents.bulkDestroy') }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data yang dipilih?')">
                            @csrf @method('DELETE')
                                ...
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left">
                                        <input type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" 
                                            @change="
                                                $el.checked ? 
                                                selected = [{{ $contingents->pluck('id')->implode(',') }}] : 
                                                selected = [];
                                                updateCount();
                                            ">
                                    </th>
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <input type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" 
                                            value="{{ $contingent->id }}" x-model="selected" @change="updateCount()">
                                    </td>
                                    @endrole
                                ...
                                @empty
                                <tr><td colspan="6" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">Kontingen tidak ditemukan</td></tr>
                                @endforelse
                            </tbody>
                        </table>
                    </div>
