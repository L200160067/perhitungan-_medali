<x-app-layout title="Import Dojang">
    <x-slot name="header">
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="mb-6">
                        ...
                        <ul class="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1">
                            ...
                            <li>Kolom yang wajib ada: <strong>nama</strong>.</li>
                        </ul>
                    </div>
                    ...
                    <form action="{{ route('dojangs.storeImport') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <a href="{{ route('dojangs.index') }}" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100">{{ __('Batal') }}</a>
                        </div>
                    </form>
                </div>
            </div>
