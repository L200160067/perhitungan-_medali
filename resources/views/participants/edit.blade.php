                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select name="gender" id="gender"
                            ...
                            @foreach($genders as $gender)
                                <option value="{{ $gender->value }}" {{ old('gender', $participant->gender->value) == $gender->value ? 'selected' : '' }}>{{ $gender->label() }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        @if($participant->photo)
                            <div class="mt-2 mb-4">
                                <img src="{{ asset('storage/' . $participant->photo) }}" alt="Foto peserta"
                                    class="w-24 h-32 object-cover rounded-md border border-gray-300 dark:border-gray-600">
                            </div>
                        @endif
                        ...
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Format: JPG/PNG/WebP, Maks: 5MB. Foto
                            akan otomatis di-crop dan dikompres. Biarkan kosong jika tidak ingin mengubah foto.</p>
