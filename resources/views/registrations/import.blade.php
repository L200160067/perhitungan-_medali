        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @if ($errors->any())
                        <div
                            class="mb-6 p-4 bg-red-50 dark:bg-red-900/50 border-l-4 border-red-500 text-red-700 dark:text-red-200">
                    ...
                    <form action="{{ route('registrations.storeImport') }}" method="POST" enctype="multipart/form-data"
                        class="space-y-6">
                        @csrf
