...
@php $header = 'Tambah Pendaftaran Baru'; @endphp
    ...
    <form action="{{ route('registrations.store') }}" method="POST" class="bg-white shadow-md rounded-lg p-6">
        ...
        <div class="space-y-6">
            ...
            <div class="flex items-center justify-end space-x-3 pt-4 border-t">
                ...
                <button type="submit" class="inline-flex items-center rounded-md bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500">Simpan Pendaftaran</button>
            </div>
        </div>
    </form>
</div>
