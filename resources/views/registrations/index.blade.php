<x-app-layout title="Pendaftaran">
    ...
    <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden" x-data="{ 
        ...
        <div class="p-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
            <form id="bulk-delete-form" action="{{ route('registrations.bulkDestroy') }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data yang dipilih?')">
                @csrf
                @method('DELETE')
        ...
        <div class="overflow-x-auto">
            ...
            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                ...
                @empty
                <tr>
                    <td colspan="9" class="px-4 py-12 text-center text-gray-500 dark:text-gray-400">Pendaftaran tidak ditemukan</td>
                </tr>
                @endforelse
            </tbody>
        </table>
